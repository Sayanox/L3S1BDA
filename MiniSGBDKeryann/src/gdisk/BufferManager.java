...
public class BufferManager {
	...
	private static int TimeCount; // Rajouter dans frame afin d'avoir un historique des actions et de savoir
									// l'ordre a utiliser
	public String value;
	...
	public ByteBuffer GetPage(PageId pageId) {
		// faire un for qui regarde si une farme a cette page ouverte et ultiliser pour
		// la suite
